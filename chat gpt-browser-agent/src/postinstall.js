// src/postinstall.js — Runs after `npm install -g chatgpt-browser-agent`
...
if (process.env.CI || process.env.SKIP_PLAYWRIGHT_INSTALL) {
  console.log('[chatgpt-agent] Skipping Playwright browser install (CI detected).');
  process.exit(0);
}

console.log('');
console.log('╔══════════════════════════════════════════════════╗');
console.log('║   🤖  ChatGPT Browser Agent — Setup              ║');
console.log('╚══════════════════════════════════════════════════╝');
console.log('');
...
try {
  ...
  console.log('    chatgpt-agent --interactive');
  console.log('    chatgpt-agent "build a REST API in Express"');
  console.log('');
} catch (err) {
  console.warn('');
